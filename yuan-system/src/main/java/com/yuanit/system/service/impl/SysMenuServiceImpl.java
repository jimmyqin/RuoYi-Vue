...
import com.yuanit.system.domain.vo.MetaVo;
import com.yuanit.system.domain.vo.RouterVo;
import com.yuanit.system.mapper.SysMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public boolean checkMenuExistRole(Long menuId) {
        Long result = roleMenuMapper.checkMenuExistRole(menuId);
        return result > 0;
    }
     ...
     */
    @Override
    public Long updateMenu(SysMenu menu) {
