package com.yuanit.common.utils.poi;
...
import com.yuanit.common.annotation.Excel;
...
import com.yuanit.common.utils.file.FileTypeUtils;
import com.yuanit.common.utils.file.FileUtils;
import com.yuanit.common.utils.file.ImageUtils;
import com.yuanit.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    private void addStatisticsData(Integer index, String text, Excel entity) {
        if (entity != null && entity.isStatistics()) {
            ...
            try {
                ...
                log.error("合计统计信息失败 {}", e.getMessage());
    ...
    public void addStatisticsRow() {
        if (MapUtils.isNotEmpty(statistics)) {
    ...
    public boolean isSubListValue(T vo) {
        return CollectionUtils.isNotEmpty(subFields) && CollectionUtils.isNotEmpty(getListCellValue(vo));
    }
